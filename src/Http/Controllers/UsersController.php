...
final class UsersController
{
    ...
    public static function buildPermissionGroups(): array
    {
        return [
            ...
            'visibilita' => [
                'label' => 'Visibilità Dati',
                'icon'  => 'M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z M12 15a3 3 0 100-6 3 3 0 000 6z',
                'color' => '#16a34a',
                'perms' => [
                    'view_prices' => ['label' => 'Vede prezzi e costi', 'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'color' => '#16a34a'],
                ],
            ],
            'contabilita' => [
            ...
            'cantieri' => [
                ...
                'perms' => [
                    ...
                    'zone'             => ['label' => 'BOB Zone',         'icon' => 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7', 'color' => '#0d9488'],
                    'worksites_drafts' => ['label' => 'Cantieri Bozze',   'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'color' => '#dc2626'],
            ...
            'mezzi' => [
                ...
                'perms' => [
                    ...
                    'fleet_view'   => ['label' => 'Flotta (visualizza)', 'icon' => 'M9 17a2 2 0 11-4 0 2 2 0 014 0zm0 0h6m4 0a2 2 0 11-4 0 2 2 0 014 0zM13 5h.01M19 13l1.5 6m-6.5-6h.01M7 9h10l2 4H5l2-4z', 'color' => '#0ea5e9'],
                    'fleet_manage' => ['label' => 'Flotta (gestisci)',   'icon' => 'M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a1 1 0 01-1-1V9a1 1 0 011-1h1a2 2 0 100-4H4a1 1 0 01-1-1V4a1 1 0 011-1h3a1 1 0 001-1z', 'color' => '#0369a1'],
                ],
            ],
            'programmazione' => [
            ...
            'direzione' => [
                ...
                'perms' => [
                    'report_business' => [
                        'label' => 'Andamento fatturato (Business)',
                        'icon'  => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
                        'color' => '#0f766e',
                    ],
                ],
            ...
            'poti' => [
                ...
                'perms' => [
                    'pn_autocarrate' => [
                        'label' => 'Autocarrate e prenotazioni',
                        'icon'  => 'M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6 0a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0',
                        'color' => '#0369a1',
                    ],
            ...
            'gruppo' => [
                ...
                'perms' => [
                    'societa' => [
                        'label' => 'Gestione societa\' del gruppo',
                        'icon'  => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
                        'color' => '#1e3a5f',
                    ],
                ],
