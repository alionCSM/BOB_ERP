        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.edit-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    document.querySelector('input[name="anticipo_id"]').value = this.dataset.id;
                    ...
                    document.querySelector('textarea[name="note"]').value = this.closest('tr').querySelector('[data-note]').dataset.note || '';
            ...
            document.getElementById('searchInput').addEventListener('input', function() {
                ...
                const rows = document.querySelectorAll('#anticipiTable tbody tr');
