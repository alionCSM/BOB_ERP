...
// Event delegation for modal toggle (button might not exist on page load)
document.addEventListener('click', function(e) {
    const button = e.target.closest('[data-tw-toggle="modal"]');
    if (button && button.getAttribute('data-tw-target') === '#modal-notes') {
        openModal();
    }
});
